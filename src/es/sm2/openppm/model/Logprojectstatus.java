...
import es.sm2.openppm.model.base.BaseLogprojectstatus;
...
public class Logprojectstatus extends BaseLogprojectstatus {
    ...
    public Logprojectstatus(Project project, Employee employee, char projectStatus, char investmentStatus, Date logDate) {
		super();
