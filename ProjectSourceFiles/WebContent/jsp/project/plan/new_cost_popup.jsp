	...
	if (costValidator.form()) {
		...
		planAjax.call(params,function(data) {
			...
			var dataRow = [
				...
				'<img onclick="'+functionCost+'(this,\''+typeCost+'\', \''+data.type+'\')" title="<fmt:message key="view"/>" class="link" src="images/view.png">'+
				'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'+
				'<img onclick="deleteCost(this, \''+data.type+'\')" title="<fmt:message key="delete"/>" class="link" src="images/delete.jpg">',
				$('#budget_account').val()
			];
