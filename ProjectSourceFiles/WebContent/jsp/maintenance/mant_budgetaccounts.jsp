	...
	if (budgetAccountsValidator.form()) {
		...
		mainAjax.call(params, function(data){
			var dataRow = [
				...
				'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'+
				'<img onclick="return deleteBudgetAccounts(this);" title="<fmt:message key="delete"/>" class="link" src="images/delete.jpg">'           
			];
...
function editBudgetAccounts(element) {
		...
		var budgetAccounts = budgetAccountsTable.fnGetData( element.parentNode.parentNode );	
...
readyMethods.add(function () {
	...
	$('#tb_budgetaccounts tbody tr').live('click',  function (event) {
		fnSetSelectable(budgetAccountsTable, this);
	});
