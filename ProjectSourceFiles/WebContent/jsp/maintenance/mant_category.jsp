	...
	if (categoryValidator.form()) {
		...
		mainAjax.call(params, function(data){
			var dataRow = [
				...
				'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'+
				'<img onclick="deleteCategory(this);" title="<fmt:message key="delete"/>" class="link" src="images/delete.jpg">'
			];
...
function editCategory(element) {
		...
		var category =categorysTable.fnGetData( element.parentNode.parentNode );
...
readyMethods.add(function () {
	...
	$('#tb_categorys tbody tr').live('click',  function (event) {
		fnSetSelectable(categorysTable, this);
	});
			...
			<table id="tb_categorys" class="tabledata" cellspacing="1" width="100%">
				<thead>
					<tr>
					 ...
					 <th width="62%"><fmt:message key="maintenance.category.description" /></th>
					 <th width="8%">
	...
	<form name="frm_category_pop" id="frm_category_pop">
		<fieldset>
			...
			<table border="0" cellpadding="2" cellspacing="1" width="100%">
				...
				<tr>
				 <th><fmt:message key="maintenance.category.description" /></th>
				 <th>&nbsp;</th>
				</tr>
				<tr>
					<td>
