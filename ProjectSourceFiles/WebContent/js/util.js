 ...
 * @param funcion_confirm Function to execute on confirm
 * @return
 */

function confirmUI(title, msg, msg_yes, msg_no, funcion_confirm) {
	$('#dialog-confirm-msg').html(msg);
	$('#dialog-confirm').dialog("option", "buttons",
			{
		'No': function() {$('#dialog-confirm').dialog("close"); },
		'Yes': function() { $('#dialog-confirm').dialog("close"); funcion_confirm(); }
			}
	);
