	...
	if (performingorgValidator.form()) {
		...
		mainAjax.call(params, function(data){	
			var dataRow = [
				...
				'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'+
				'<img onclick="deletePerformingOrg(this);" title="<fmt:message key="delete"/>" class="link" src="images/delete.jpg">',
...
function editPerformingOrg(element) {
	...
	var performing = performingorgsTable.fnGetData( element.parentNode.parentNode );
...
readyMethods.add(function () {
	...
	$('#tb_performingorgs tbody tr').live('click',  function (event) {
		fnSetSelectable(performingorgsTable, this);
	});
