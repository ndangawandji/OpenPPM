...
------------------------------------------------------------------------------%>
<%@page import="es.sm2.openppm.model.Changetype"%>
...
function editChangeType(element) {
	...
	var changeType = changeTypesTable.fnGetData( element.parentNode.parentNode );
...
readyMethods.add(function () {
	...
	$('#tb_changetypes tbody tr').live('click',  function (event) {
		fnSetSelectable(changeTypesTable, this);
	});
