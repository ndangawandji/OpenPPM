...
<%@page import="es.sm2.openppm.model.Bscdimension"%>
...
function editMetric(element) {
	...
	$(f.<%=Metrickpi.DEFINITION%>).text(unEscape(aData[2]));
	f.<%=Bscdimension.IDBSCDIMENSION%>.value = aData[4];
...
readyMethods.add(function () {
	...
	$('#tb_metrics tbody tr').live('click',  function (event) {
		fnSetSelectable(metricsTable, this);
	});
	...
	<table id="tb_metrics" class="tabledata" cellspacing="1" width="100%">
		<thead>
			<tr>
			 ...
			 <th width="30%"><fmt:message key="metric.bsc_dimension" /></th>
			 <th width="0%">&nbsp;</th>
			 <th width="10%">
	...
	<form name="frm_metrics_pop" id="frm_metrics_pop">
		...
		<fieldset>
			...
			<table cellpadding="2" cellspacing="1" width="100%">
				...
				<tr>
					<td><input type="text" name="<%=Metrickpi.NAME %>" class="campo" maxlength="50"/></td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						<select name="<%=Bscdimension.IDBSCDIMENSION %>" class="campo">
