	...
	if (geographyValidator.form()) {
		mainAjax.call(params, function(data){
			var dataRow = [
				...
				'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'+
				'<img onclick="deleteGeography(this)" title="<fmt:message key="delete"/>" class="link" src="images/delete.jpg">'
		    ];
...
function editGeography(element) {
		...
		var geography =geographysTable.fnGetData( element.parentNode.parentNode );
...
readyMethods.add(function () {
	...
	$('#tb_geographys tbody tr').live('click',  function (event) {
		fnSetSelectable(geographysTable, this);
	} );
