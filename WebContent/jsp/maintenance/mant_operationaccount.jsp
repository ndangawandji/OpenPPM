	...
	if (operationAccountValidator.form()) {
		...
		mainAjax.call(params, function(data){
			var dataRow = [
				...
				'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'+
				'<img onclick="deleteOperationAccount(this)" title="<fmt:message key="delete"/>" class="link" src="images/delete.jpg">'          
			];
...
function editOperationAccount(element) {
		...
		var operationAccount = operationAccountsTable.fnGetData( element.parentNode.parentNode );
...
readyMethods.add(function () {
	...
	$('#tb_operationaccount tbody tr').live('click',  function (event) {
		fnSetSelectable(operationAccountsTable, this);
	});
