	...
	if (fundingSourceValidator.form()) {
		...
		mainAjax.call(params, function(data){
			var dataRow = [
				...
				'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'+
				'<img onclick="deleteFundingSource(this)" title="<fmt:message key="delete"/>" class="link" src="images/delete.jpg">'          
			];
...
function editFundingSource(element) {
		...
		var fundingSource = fundingSourceTable.fnGetData( element.parentNode.parentNode );
...
readyMethods.add(function () {
	...
	$('#tb_fundingsource tbody tr').live('click',  function (event) {
		fnSetSelectable(fundingSourceTable, this);
	});
