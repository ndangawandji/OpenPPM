	...
	if (expenseAccountValidator.form()) {
		...
		mainAjax.call(params, function (data) {
			var dataRow = [
				...
				'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'+
				'<img onclick="deleteExpenseAccount(this);" title="<fmt:message key="delete"/>" class="link" src="images/delete.jpg">'
		    ];
...
function editExpenseAccount(element) {
		...
		var  expenseAccount = expenseAccountsTable.fnGetData( element.parentNode.parentNode );
...
readyMethods.add(function () {
	...
	$('#tb_expenseaccounts tbody tr').live('click',  function (event) {
		fnSetSelectable(expenseAccountsTable, this);
	});
