	...
	if (customerValidator.form()) {
		...
		mainAjax.call(params, function(data){
			var dataRow = [ 
				...
				'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'+
				'<img onclick="deleteCustomer(this);" title="<fmt:message key="delete"/>" class="link" src="images/delete.jpg">',
				f.type.value
		    ];
...
function editCustomer(element) {
		...
		var customer =customersTable.fnGetData( element.parentNode.parentNode );
...
readyMethods.add(function () {
	...
	$('#tb_customers tbody tr').live('click',  function (event) {
		fnSetSelectable(customersTable, this);
	});
